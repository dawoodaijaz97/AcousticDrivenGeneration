# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 01:38:39 2025
...
with torch.no_grad():
    ...
    model_dir = './models/'+sample_size+'_t5_'+model_type+'_random'
    ...
    for split in range(1,3):
        ...
        test_data = test_data[test_data['Group']==filename]
        #-
        ...
        ground_truth_answers = list(test_data["Report"])
