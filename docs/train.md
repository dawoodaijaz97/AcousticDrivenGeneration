...
| Raw `Instructions` encoder input (B24, `--input-format instructions-raw`) | AVG 0.479 vs B11 0.538 — compact seven-score input wins; do not revisit input format |
...
- **B20** — Moderate+ **2× oversample** + LoRA r=32 on B17, 3 ep — AVG **0.542** (≈ tie B17); coverage **≈14%** unchanged; **closed**
